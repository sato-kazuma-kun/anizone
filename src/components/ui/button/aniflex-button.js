...
// function Button({ txtColor, bgColor, size, children, linkClick, functionClick, disabled }) {
...
//             functionClick();
//         } else if (linkClick != null) {
//             // If clickLink is provided, navigate to the specified URL
...
function AniflexButton({ txtColor, bgColor, size, children, click }) {
    const router = useRouter()
